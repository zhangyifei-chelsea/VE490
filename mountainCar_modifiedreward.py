...
for i_episode in range(200):
    if EPSILON<EPSILON_THRESHOLD:  # in this setting they are both 0.9, no increase actually
    ...
    for i in range(500):
        ...
        if position < -0.6:
            ...
            modified_reward = 0
        dqn.store_transition(s, a, modified_reward, s_)
        s = s_
...
torch.save(dqn.getOnlineNet(), 'mountainCar_dqn_modified_reward_10neu_200ep')
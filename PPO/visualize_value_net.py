...
import PPO.Cartpole_playground_value_net as Cartpole_playground
...
if __name__=="__main__":
    ...
    dir=""
    model_name="../dropout/Cartpole_dqn_without_dropout_300ep_5layer_128neu_0.001lr"   # can modify here
    dropout=False
    model = Net()
    model = torch.load(dir+model_name)
    ...
    if num_of_dir ==1:
        ...
        x = list(np.linspace(-1.5,1.5,51))  # can modify here
        y = list(np.linspace(-1.5,1.5,51))  # can modify here
